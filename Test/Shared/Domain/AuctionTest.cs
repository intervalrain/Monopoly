...
public class AuctionTest
{
    ...
    {
        // Arrange
        Monopoly game = 玩家A持有1000元_玩家B持有2000元_玩家A擁有A1_A1的價格為1000_玩家A正在拍賣A1(out var a, out var b);
        b.Money = 3000;
    ...
    private static Monopoly 玩家A持有1000元_玩家B持有2000元_玩家A擁有A1_A1的價格為1000_玩家A正在拍賣A1(out Player a, out Player b)
    {
        var map = new Map(Utils.SevenXSevenMap);
        Monopoly game = new Monopoly("g1", map);
        a = new("A", 1000);
        b = new("B", 2000);
        game.AddPlayers(a, b);
        game.Initial();
